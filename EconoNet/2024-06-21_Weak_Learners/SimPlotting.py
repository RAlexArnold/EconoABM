...
class SimPlotting:
    ...
    def _plotXi(self, ax, i, Xarray, X, lw1, lw2, *, med=False):
        ...
        if med:
            Xmed = np.median(Xarray[:,i], axis=1)
            ax.plot(self.trange-t0, Xmed, c='r', lw=lw1)
    ...
    def plotQi(self, ax, i, *, lw1=0.1, lw2=0.05, w=4,h=2, xmin=None, xmax=None, ymin=None, ymax=None, med=False):
        
        Xarray = self.Qarray
        self._plotXi(ax, i, Xarray, 'Q', lw1, lw2, med=med)
        
    def plotDi(self, ax, i, *, lw1=0.1, lw2=0.05, w=4, h=2, xmin=None, xmax=None, ymin=None, ymax=None, med=False):
    
        Xarray = self.Darray
        self._plotXi(ax, i, Xarray, 'D', lw1, lw2, med=med)
        
    def plotQuantities(self, *, mw=4, mh=8, qmin=None, qmax=None, cmin=None, cmax=None, Qmin=None, Qmax=None, Dmin=None, Dmax=None, qlog=False, clog=False, Qlog=True, Dlog=True, tight_layout=False, med=False, **kwargs):
        ...
        for i in range(self.Nproducts):
            ...
            self.plotQi(axs[2,i], i, med=med, **kwargs)
            self.plotDi(axs[3,i], i, med=med, **kwargs)
    ...
    def plotA(self, *, lw1=0.5, lw2=0.1, w=4,h=2, xmin=None, xmax=None, ymin=None, ymax=None, ewm=False, alpha=0.5):
        ...
        action_name = {0: '0', 1: 'L', 2: 'C', 3: 'E'}
        action_color = {0: 'C0', 1: 'C1', 2: 'C2', 3: 'C3'}
        ...
        if ewm:
            ...
            [ax.plot(self.trange-self.dt/2.0, Aprob[a], lw=lw2, c=action_color[a]) for a in self.action_space]


            [ax.plot(self.trange-self.dt/2.0, self._ewm(Aprob[a], alpha), lw=lw1, c=action_color[a], label=fr'$\varpi_{action_name[a]}$') for a in self.action_space]

        else:
            
            [ax.plot(self.trange-self.dt/2.0, Aprob[a], lw=lw1, c=action_color[a], label=fr'$\varpi_{action_name[a]}$') for a in self.action_space]

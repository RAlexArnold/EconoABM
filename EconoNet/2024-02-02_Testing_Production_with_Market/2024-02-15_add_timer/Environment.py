...
class Environment:
    def __init__(self, dt, agent_list, inst_list, market, time_unit=10): # include an action dict that specifies which number goes to which action
    ...
    def env_step(self, action_dict):
        ...
        self.time = self.time % self.time_unit
